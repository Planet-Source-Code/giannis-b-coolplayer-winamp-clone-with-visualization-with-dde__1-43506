...
Private Sub Form_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If GL.bClick Then Call MoveForm(frmPl, Button, GL.X, GL.Y, X, Y)
End Sub
...
Private Sub picRem_Click()
    ...
    If GL.bClick Then Call PopupMenu(frmMnu.mnuMisc, , picRem.Left - 50, picRem.Top - 800)
    'Call SHSel(True)
    GL.bClick = False
...
Private Sub picRem_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picRem, Button, X, Y) Then
     Call PlRemDown
    Else
     Call PlRemUp
    End If
...
Private Sub picExp_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picExp, Button, X, Y) Then
     Call PExitDown
    Else
     Call PExitUp
    End If
...
Private Sub picFile_Click()
    ...
    If GL.bClick Then Call PopupMenu(frmMnu.mnuF, , picFile.Left - 50, picFile.Top - 800)
    GL.bClick = False
...
Private Sub picFile_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picFile, Button, X, Y) Then
     Call PlFileDown
    Else
     Call PlFileUp
    End If
...
Private Sub picList_Click()
    ...
    If GL.bClick Then Call PopupMenu(frmMnu.mnuL, , picList.Left - 850, picList.Top - 1300)
    'Call SHList(True)
    GL.bClick = False
...
Private Sub picList_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picList, Button, X, Y) Then
     Call PlListDown
    Else
     Call PlListUp
    End If
...
Private Sub picOpt_Click()
    ...
    If GL.bClick Then Call PopupMenu(frmMnu.mnuP, , picOpt.Left - 50, picOpt.Top - 1440)
    'Call SHMisc(True)
    GL.bClick = False
...
Private Sub picTrack_Click()
    ...
    If GL.bClick Then Call PopupMenu(frmMnu.mnuT, , picTrack.Left - 50, picTrack.Top - 2080)
    'Call SHRem(True)
    GL.bClick = False
...
Private Sub picTrack_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picTrack, Button, X, Y) Then
     Call PlTrackDown
    Else
     Call PlTrackUp
    End If
...
Private Sub l_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    ElseIf Button = 1 Then
     If X >= 0 And X <= l.Width And Y >= 0 And Y <= l.Height Then
      If CI.bClick Then
       If l.ListItems.Count <> 0 Then Call GetPlay(True)
      End If
     End If
    End If
