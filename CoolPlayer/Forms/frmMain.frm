...
Begin VB.Form frmMn 
   ...
   Begin VB.PictureBox Scope 
      ...
      ScaleWidth      =   76
      TabIndex        =   40
      ToolTipText     =   "Click to change visualization"
      Top             =   650
      Visible         =   0   'False
      Width           =   1140
   End
   ...
   Begin VB.PictureBox pSc 
      ...
      ScaleWidth      =   2310
      TabIndex        =   28
      ToolTipText     =   "Current track playing"
      Top             =   400
      Width           =   2310
   End
...
Private Sub Form_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If GL.bClick Then Call MoveForm(frmMn, Button, GL.X, GL.Y, X, Y, True)
...
Private Sub picMBal_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    On Error GoTo MError
    If GL.bDrag Then Call MoveBalance(X)
...
Private Sub picRe_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picRe, Button, X, Y) Then
     Call LoopDown
    Else
     Call LoopUp
    End If
...
Private Sub picMin_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picMin, Button, X, Y) Then
     Call MinDown
    Else
     Call MinUp
    End If
...
Private Sub picNe_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picNe, Button, X, Y) Then
     Call NextDown
    Else
     Call NextUp
    End If
...
Private Sub picOp_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picOp, Button, X, Y) Then
     Call OpenDown
    Else
     Call OpenUp
    End If
...
Private Sub picOpt_Click()
    ...
    If GL.bClick Then Call PopupMenu(frmMnu.mnuO, , picOpt.Left + 200, picOpt.Top)
    GL.bClick = False
...
Private Sub picOpt_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picOpt, Button, X, Y) Then
     Call AboutDown
    Else
     Call AboutUp
    End If
...
Private Sub picPa_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picPa, Button, X, Y) Then
     Call PauseDown
    Else
     Call PauseUp
    End If
...
Private Sub picPl_Click()
    ...
    If GL.bClick Then Call GetPlay(True)
    GL.bClick = False
...
Private Sub picPl_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picPl, Button, X, Y) Then
     Call PlayDown
    Else
     Call PlayUp
    End If
...
Private Sub imgPlaylist_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(imgPlaylist, Button, X, Y) Then
     Call PlDown
    Else
     Call PlUp
    End If
...
Private Sub picRv_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picRv, Button, X, Y) Then
     Call PrevDown
    Else
     Call PrevUp
    End If
...
Private Sub picSh_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picSh, Button, X, Y) Then
     Call ShuffDown
    Else
     Call ShuffUp
    End If
...
Private Sub picMSli_Click()
    ...
    If GL.bClick Then Call PopupMenu(frmTim.mnuTo, , picMSli.Left, picMSli.Top - 1070)
    GL.bClick = False
...
Private Sub picSt_Click()
    ...
    If GL.bClick Then Call StopPlay
    GL.bClick = False
...
Private Sub picSt_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picSt, Button, X, Y) Then
     Call StopDown
    Else
     Call StopUp
    End If
...
Private Sub picCl_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(picCl, Button, X, Y) Then
     Call TopDown
    Else
     Call TopUp
    End If
...
Private Sub picMVol_Click()
    ...
    If GL.bClick Then Call PopupMenu(frmMnu.mnuMute, , picMVol.Left, picMVol.Top - 420)
    GL.bClick = False
    Call SaveIniSettings(False)
...
Private Sub picMSli_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    On Error GoTo SError
    If GL.sDrag Then Call MoveSlider(X, MP.duration)
...
Private Sub picMSli_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Button = 1 Then
     Call PlaySlider(MoveSlider(X, MP.duration))
     GL.sDrag = False
     Call SliderUp
    End If
...
Private Sub picMVol_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If GL.vDrag Then Call MoveVolume(X)
End Sub
...
Private Sub imgEq_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Allow(imgEq, Button, X, Y) Then
     Call EqDown
    Else
     Call EqUp
    End If
...
Private Sub Scope_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Button Then PL.Vis = IIf(PL.Vis = 2, 0, PL.Vis + 1)
End Sub
Private Sub tmrVis_Timer()
    Call Vis.GetData(Scope, PL.Vis)
End Sub
Private Sub tmrScroller_Timer()

    On Error GoTo TError
    Call ScrollText(frmMn.pSc)
    Call TimePosition(MP.CurrentPosition, True)
    Call BarMove: Call ShowCount
    If MP.EndOfStream Then Call CheckOnEnd
